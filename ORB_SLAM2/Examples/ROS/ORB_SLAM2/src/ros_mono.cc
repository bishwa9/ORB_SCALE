...
public:
    ...
    void GrabHeight(const std_msgs::Float64 &height_msg);
...
void ImageGrabber::GrabHeight(const std_msgs::Float64 &height_msg)
{
...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr& msg)
{
    if(height >= 0)
    {
        ...
        mpSLAM->TrackMonocular(cv_ptr->image, height, cv_ptr->header.stamp.toSec());
    }
}
